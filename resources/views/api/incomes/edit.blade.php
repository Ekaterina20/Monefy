...
@section ('title', 'Изменение дохода')
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            {!! Form::model($income_site, ['url'=>"api/incomes/{$income_site->slug}/edit", 'method'=>'post', 'class'=>'form-horizontal', 'files'=>true]) !!}
            ...
            <img style="background-color: {{$income_site->color}}" src="{{url("images/{$income_site->icon}")}}" class="img-fluid my-4">
